...
class deposant extends personne{
    ...
    function toHTML() {
        return $this->nom." ". $this->prenom." ". $this-> civilite." ". $this->mail." ". $this->getAdresse()->getNumero()." ".$this->getAdresse()->getVoie()." ".$this->getAdresse()->getVille()." ".$this->getAdresse()->getCp()." ";
...
class architecte extends personne{
    ...
    if(strlen($telephone)==10)
     ...
     function toHTML() {
        return $this->nom." ". $this->prenom." ". $this->conseilRegional." ". $this->getAdresse()->getNumero()." ".$this->getAdresse()->getVoie()." ".$this->getAdresse()->getVille()." ".$this->getAdresse()->getCp()." ".$this->telephone;
...
abstract class personne{
    ...
    protected function validerChaine($chaine, $taille)
    {
        if(strlen($chaine)<=$taille)
        {
            return $chaine;
